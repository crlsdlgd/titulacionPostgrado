 ...
 * @version 1.0
 */
public class CarreraDtoJdbcValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public CarreraDtoJdbcValidacionException() {
		super();
	}
	 ...
	 */
	public CarreraDtoJdbcValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public CarreraDtoJdbcValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public CarreraDtoJdbcValidacionException(Throwable cause) {
		super(cause);
	}
}
