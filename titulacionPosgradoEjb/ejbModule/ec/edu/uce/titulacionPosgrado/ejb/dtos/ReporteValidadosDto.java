 ...
 * @version 1.0
 */
public class ReporteValidadosDto implements Serializable{
	...
	public ReporteValidadosDto() {
	}
	
	
	public ReporteValidadosDto(String carrera, String nivel, String cedula,
			String apellido1, String apellido2, String nombres, String mail,
			String telefono, String mctt_estadistico, String validacion,
			String observacionDesactivar) {
