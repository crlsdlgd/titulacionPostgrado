 ...
 * @version 1.0
 */
public class EstudianteValidacionDtoNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public EstudianteValidacionDtoNoEncontradoException() {
		super();
	}
	 ...
	 */
	public EstudianteValidacionDtoNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public EstudianteValidacionDtoNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public EstudianteValidacionDtoNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
