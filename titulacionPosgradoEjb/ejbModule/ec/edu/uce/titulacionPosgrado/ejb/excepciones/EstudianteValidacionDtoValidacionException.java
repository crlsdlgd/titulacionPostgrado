 ...
 * @version 1.0
 */
public class EstudianteValidacionDtoValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public EstudianteValidacionDtoValidacionException() {
		super();
	}
	 ...
	 */
	public EstudianteValidacionDtoValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public EstudianteValidacionDtoValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public EstudianteValidacionDtoValidacionException(Throwable cause) {
		super(cause);
	}
}
