 ...
 * @version 1.0
 */
public class FichaDcnAsgTitulacionNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public FichaDcnAsgTitulacionNoEncontradoException() {
		super();
	}
	 ...
	 */
	public FichaDcnAsgTitulacionNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public FichaDcnAsgTitulacionNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public FichaDcnAsgTitulacionNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
