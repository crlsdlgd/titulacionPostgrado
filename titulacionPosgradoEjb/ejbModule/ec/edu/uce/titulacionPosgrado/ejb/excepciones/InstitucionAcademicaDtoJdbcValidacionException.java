 ...
 * @version 1.0
 */
public class InstitucionAcademicaDtoJdbcValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public InstitucionAcademicaDtoJdbcValidacionException() {
		super();
	}
	 ...
	 */
	public InstitucionAcademicaDtoJdbcValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public InstitucionAcademicaDtoJdbcValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public InstitucionAcademicaDtoJdbcValidacionException(Throwable cause) {
		super(cause);
	}
}
