 ...
 * @version 1.0
 */
public class EvaluadosDtoJdbcValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public EvaluadosDtoJdbcValidacionException() {
		super();
	}
	 ...
	 */
	public EvaluadosDtoJdbcValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public EvaluadosDtoJdbcValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public EvaluadosDtoJdbcValidacionException(Throwable cause) {
		super(cause);
	}
}
