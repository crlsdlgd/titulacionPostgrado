 ...
 * @version 1.0
 */
public class MecanismoTitulacionCarreraDtoJdbcNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public MecanismoTitulacionCarreraDtoJdbcNoEncontradoException() {
		super();
	}
	 ...
	 */
	public MecanismoTitulacionCarreraDtoJdbcNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public MecanismoTitulacionCarreraDtoJdbcNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public MecanismoTitulacionCarreraDtoJdbcNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
