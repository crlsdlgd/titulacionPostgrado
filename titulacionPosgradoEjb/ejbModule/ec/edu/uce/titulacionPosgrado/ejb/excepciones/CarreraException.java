 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:     CarreraException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Carrera.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)CarreraException.
 * Clase de excepcion general para la entidad Carrera.
 * @author dalbuja
 * @version 1.0
 */
public class CarreraException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public CarreraException(Throwable cause) {
		super(cause);
	}
}
