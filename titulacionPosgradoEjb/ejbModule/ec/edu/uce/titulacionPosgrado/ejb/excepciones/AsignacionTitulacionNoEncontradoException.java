 ...
 * @version 1.0
 */
public class AsignacionTitulacionNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public AsignacionTitulacionNoEncontradoException() {
		super();
	}
	 ...
	 */
	public AsignacionTitulacionNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public AsignacionTitulacionNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public AsignacionTitulacionNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
