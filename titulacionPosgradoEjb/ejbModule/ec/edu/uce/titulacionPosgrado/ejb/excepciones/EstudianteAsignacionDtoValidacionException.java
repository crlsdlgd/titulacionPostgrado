 ...
 * @version 1.0
 */
public class EstudianteAsignacionDtoValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public EstudianteAsignacionDtoValidacionException() {
		super();
	}
	 ...
	 */
	public EstudianteAsignacionDtoValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public EstudianteAsignacionDtoValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public EstudianteAsignacionDtoValidacionException(Throwable cause) {
		super(cause);
	}
}
