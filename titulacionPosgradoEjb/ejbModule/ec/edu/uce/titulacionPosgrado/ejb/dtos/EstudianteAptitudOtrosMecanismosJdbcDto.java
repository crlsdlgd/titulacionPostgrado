 ...
 ************************************************************************* 
 ...
 ARCHIVO:     EstudianteAptitudOtrosMecanismosJdbcDto.java	  
 DESCRIPCION: DTO encargado de manejar los datos del estudiante evaluado para ser declarado apto. 
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (DTO) EstudianteAptitudOtrosMecanismosJdbcDto.
 * DTO encargado de manejar los datos del estudiante evaluado para ser declarado apto.
 * @author dalbuja.
 * @version 1.0
 */
public class EstudianteAptitudOtrosMecanismosJdbcDto implements Serializable {
	...
	private String prtrRutaArchivoAutorizacion;
	...
	// Constructores
	public EstudianteAptitudOtrosMecanismosJdbcDto(){
	...
	public String getPrtrRutaArchivoAutorizacion() {
		return prtrRutaArchivoAutorizacion;
	}

	public void setPrtrRutaArchivoAutorizacion(String prtrRutaArchivoAutorizacion) {
		this.prtrRutaArchivoAutorizacion = prtrRutaArchivoAutorizacion;
	}

	public Integer getMccrOpcion() {
		return mccrOpcion;
	}
	public void setMccrOpcion(Integer mccrOpcion) {
		this.mccrOpcion = mccrOpcion;
	}
