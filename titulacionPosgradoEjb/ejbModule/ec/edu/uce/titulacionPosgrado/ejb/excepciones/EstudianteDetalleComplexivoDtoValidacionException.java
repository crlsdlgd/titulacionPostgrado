 ...
 * @version 1.0
 */
public class EstudianteDetalleComplexivoDtoValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public EstudianteDetalleComplexivoDtoValidacionException() {
		super();
	}
	 ...
	 */
	public EstudianteDetalleComplexivoDtoValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public EstudianteDetalleComplexivoDtoValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public EstudianteDetalleComplexivoDtoValidacionException(Throwable cause) {
		super(cause);
	}
}
