 ...
 * por la ley.
  ************************************************************************* 
 ARCHIVO:     UbicacionException.java	  
 DESCRIPCION: Clase de excepcion general para la entidad Ubicacion.
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (Exception)UbicacionException.
 * Clase de excepcion general para la entidad Ubicacion.
 * @author dalbuja
 * @version 1.0
 */
public class UbicacionException extends Exception{
	 ...
	 * @see java.lang.Throwable
	 */
	public UbicacionException(Throwable cause) {
		super(cause);
	}
}
