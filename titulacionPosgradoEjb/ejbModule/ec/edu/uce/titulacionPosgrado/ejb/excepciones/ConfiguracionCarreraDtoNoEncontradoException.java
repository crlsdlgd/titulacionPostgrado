 ...
 * @version 1.0
 */
public class ConfiguracionCarreraDtoNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public ConfiguracionCarreraDtoNoEncontradoException() {
		super();
	}
	 ...
	 */
	public ConfiguracionCarreraDtoNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public ConfiguracionCarreraDtoNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public ConfiguracionCarreraDtoNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
