 ...
 * @version 1.0
 */
public class EstudianteAsignacionDtoNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public EstudianteAsignacionDtoNoEncontradoException() {
		super();
	}
	 ...
	 */
	public EstudianteAsignacionDtoNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public EstudianteAsignacionDtoNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public EstudianteAsignacionDtoNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
