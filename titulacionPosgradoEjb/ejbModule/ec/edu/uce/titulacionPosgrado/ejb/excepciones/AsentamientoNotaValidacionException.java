 ...
 * @version 1.0
 */
public class AsentamientoNotaValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public AsentamientoNotaValidacionException() {
		super();
	}
	 ...
	 */
	public AsentamientoNotaValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public AsentamientoNotaValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public AsentamientoNotaValidacionException(Throwable cause) {
		super(cause);
	}
}
