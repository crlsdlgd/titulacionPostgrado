 ...
 * @version 1.0
 */
public class FichaDocenteNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public FichaDocenteNoEncontradoException() {
		super();
	}
	 ...
	 */
	public FichaDocenteNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public FichaDocenteNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public FichaDocenteNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
