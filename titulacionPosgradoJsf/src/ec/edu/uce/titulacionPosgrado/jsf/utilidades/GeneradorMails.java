...
public class GeneradorMails {
	...
	public String generadorMailString(Map<String, Object> parametros, String pathTemplate){
		...
		sbHtmlMsg.append(VelocityEngineUtils.mergeTemplateIntoString(motorVelocity, "ec/edu/uce/titulacionPosgrado/jsf/velocity/plantillas/template-registro.vm", "UTF-8", parametros));
	...
	public String generarMailJson(List<String> correosTo, List<String> correosCc, List<String> correosBcc, 
		...
		if(esFirmado){
			sbHtmlMsg.append(VelocityEngineUtils.mergeTemplateIntoString(motorVelocity, "/ec/edu/uce/titulacionPosgrado/jsf/velocity/plantillas/template-pie-firma.vm", "UTF-8", parametros));
		}
