 ...
 * @version 1.0
 */
public class CarreraDtoJdbcNoEncontradoException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public CarreraDtoJdbcNoEncontradoException() {
		super();
	}
	 ...
	 */
	public CarreraDtoJdbcNoEncontradoException(String message) {
		super(message);
	}
	 ...
	 */
	public CarreraDtoJdbcNoEncontradoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public CarreraDtoJdbcNoEncontradoException(Throwable cause) {
		super(cause);
	}
}
