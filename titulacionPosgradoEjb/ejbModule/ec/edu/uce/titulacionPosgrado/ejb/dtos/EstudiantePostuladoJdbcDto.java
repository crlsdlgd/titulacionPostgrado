 ...
 ************************************************************************* 
 ...
 ARCHIVO:     EstudiantePostuladoJdbcDto.java	  
 DESCRIPCION: DTO encargado de manejar los datos del estudiante postulado. 
 *************************************************************************
                           	MODIFICACIONES
...
/**
 * Clase (DTO) EstudiantePostuladoJdbcDto.
 * DTO encargado de manejar los datos del estudiante postulado.
 * @author dalbuja.
 * @version 1.0
 */
public class EstudiantePostuladoJdbcDto implements Serializable {
	...
	private String trttObsSecValidacion;
	...
	public EstudiantePostuladoJdbcDto(){
	...
	public String getTrttObsSecValidacion() {
		return trttObsSecValidacion;
	}

	public void setTrttObsSecValidacion(String trttObsSecValidacion) {
		this.trttObsSecValidacion = trttObsSecValidacion;
	}
	...
	public String getPrsFoto() {
		return prsFoto;
	}



	public void setPrsFoto(String prsFoto) {
