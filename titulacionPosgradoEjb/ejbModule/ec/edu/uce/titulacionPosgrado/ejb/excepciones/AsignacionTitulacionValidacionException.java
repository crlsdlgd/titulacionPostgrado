 ...
 * @version 1.0
 */
public class AsignacionTitulacionValidacionException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepcion.
	 */
	public AsignacionTitulacionValidacionException() {
		super();
	}
	 ...
	 */
	public AsignacionTitulacionValidacionException(String message) {
		super(message);
	}
	 ...
	 */
	public AsignacionTitulacionValidacionException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public AsignacionTitulacionValidacionException(Throwable cause) {
		super(cause);
	}
}
